...
- `CLAUDE.md` dosyasındaki `EnglishWord - İngilizce-Türkçe Kelime Ezberleme Uygulaması`, `EnglishWord - İngilizce-Türkçe Kelime Ezberleme Uygulaması — Premium SaaS Uygulaması`, `[TECH_STACK]` gibi alanları gerçek değerlerle değiştir
